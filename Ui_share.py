...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.tx_dl_count = QtWidgets.QTextBrowser(Dialog)
        self.tx_dl_count.setObjectName("tx_dl_count")
        self.gridLayout.addWidget(self.tx_dl_count, 4, 0, 1, 1)
        spacerItem1 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout.addItem(spacerItem1, 3, 1, 1, 1)
        self.tx_pwd = QtWidgets.QTextBrowser(Dialog)
        self.tx_pwd.setObjectName("tx_pwd")
        self.gridLayout.addWidget(self.tx_pwd, 7, 0, 1, 1)
        self.tx_share_url = QtWidgets.QTextBrowser(Dialog)
        self.tx_share_url.setObjectName("tx_share_url")
        self.gridLayout.addWidget(self.tx_share_url, 6, 0, 1, 2)
        self.tx_time = QtWidgets.QTextBrowser(Dialog)
        self.tx_time.setObjectName("tx_time")
        self.gridLayout.addWidget(self.tx_time, 5, 0, 1, 1)
        self.tx_dl_link = QtWidgets.QTextBrowser(Dialog)
        self.tx_dl_link.setObjectName("tx_dl_link")
        self.gridLayout.addWidget(self.tx_dl_link, 8, 0, 3, 3)
        self.tx_size = QtWidgets.QTextBrowser(Dialog)
        self.tx_size.setObjectName("tx_size")
        self.gridLayout.addWidget(self.tx_size, 2, 0, 1, 1)
        self.tx_name = QtWidgets.QTextBrowser(Dialog)
        self.tx_name.setObjectName("tx_name")
        self.gridLayout.addWidget(self.tx_name, 0, 0, 1, 3)
        ...
        self.lb_size.setBuddy(self.tx_size)
        self.lb_time.setBuddy(self.tx_dl_count)
        self.dl_count.setBuddy(self.tx_time)
